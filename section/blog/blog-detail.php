<div class="row-fluid" id="section-blog" style="padding-top: 22px;">
	<div class="row-fluid" style="background-color: #F7F7F7; box-shadow: 1px 0 0 3px rgba(0,0,0,0.2); display: block;">	
		<div class="container">
			<br /><br /><br />
				<h1 class="text-center" style="border-bottom: 1px solid #7D7D7D; font-family: times new roman; font-size: 41.5px;"><i class="icon icon-globe" style="-webkit-transform:scale(2.0); -moz-transform:scale(2.0); -o-transfrom:scale(2.0); transform:scale(2.0); margin-top: 12.9px;"></i> Detail Blog</h1>
					</div><br />
							<div class="container">
							<div class="span1"></div>
							<div class="span3">
