<div class="row-fluid" id="section-layanan" style="padding-top: 22px;">
	<div class="row-fluid" style="background-color: #F7F7F7; box-shadow: 1px 0 0 3px rgba(0,0,0,0.2); display: block;">	
		<div class="container">
			<br /><br /><br />
				<h1 class="text-center" style="border-bottom: 1px solid #363636;"><i class="icon icon-bookmark" style="-webkit-transform:scale(2.0); -moz-transform:scale(2.0); -o-transfrom:scale(2.0); transform:scale(2.0); margin-top: 12px;"></i> Detail Layanan</h1>
					</div><br />
							<div class="container">
							<div class="span1"></div>
							<div class="span3">
							<?php
							require("section/layanan/layanan-list.php");
...
echo "<img src='./$gambar' width='55%' height='55%' alt='' class='img img-polaroid'>
	<h4>$judul</h4>
	<p align='justify'>
